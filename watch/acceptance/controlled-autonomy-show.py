...
INDEX = Path(os.environ.get("SPOT_ACCEPTANCE_ROOT", "/mnt/collective/logs/spot/acceptance")) / "index.jsonl"

def main():
    ap = argparse.ArgumentParser(description="Show controlled autonomy acceptance records")
