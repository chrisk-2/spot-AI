...
p = subprocess.run(
    ["python3", "watch/approval/approval-escalation-chain-snapshot.py"],
    text=True,
    capture_output=True,
)
...
for section_name in ["approval_schema", "escalation_rules"]:
...
print("RESULT: PASS")
print("module=deterministic_approval_escalation_chain mode=read_only advisory_only=true execution_allowed=false mutation_authority=false executor=spot-core")
