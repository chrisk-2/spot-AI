...
INDEX = Path(os.environ.get("SPOT_APPROVAL_ROOT", "/mnt/collective/logs/spot/approvals")) / "index.jsonl"

def main():
    ap = argparse.ArgumentParser(description="Show Spot approval escalation records")
