...
INDEX = Path(os.environ.get("SPOT_LEARNING_ROOT", "/mnt/collective/logs/spot/learning")) / "index.jsonl"

def main():
    ap = argparse.ArgumentParser(description="Show proposal-only learning records")
