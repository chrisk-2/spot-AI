...
INDEX = Path(os.environ.get("SPOT_FAILURE_ROOT", "/mnt/collective/logs/spot/failure-proofs")) / "index.jsonl"

def main():
    ap = argparse.ArgumentParser(description="Show Spot failure/crash proofs")
