...
p = subprocess.run(
    ["python3", "watch/rollback/rollback-binding-registry-snapshot.py"],
    text=True,
    capture_output=True,
)
...
for section_name in ["rollback_binding_schema", "binding_rules"]:
...
print("RESULT: PASS")
print("module=rollback_binding_registry mode=read_only advisory_only=true execution_allowed=false mutation_authority=false executor=spot-core")
