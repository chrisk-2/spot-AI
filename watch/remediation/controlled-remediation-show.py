...
INDEX = Path(os.environ.get("SPOT_REMEDIATION_ROOT", "/mnt/collective/logs/spot/controlled-remediation")) / "index.jsonl"

def main():
    ap = argparse.ArgumentParser(description="Show controlled remediation records")
