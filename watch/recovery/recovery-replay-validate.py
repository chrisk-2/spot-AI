...
p = subprocess.run(
    ["python3", "watch/recovery/recovery-replay-snapshot.py"],
    text=True,
    capture_output=True,
)
...
for section_name in ["replay_schema", "replay_rules"]:
...
print("RESULT: PASS")
print("module=governed_recovery_replay_simulation mode=read_only advisory_only=true execution_allowed=false mutation_authority=false executor=spot-core")
