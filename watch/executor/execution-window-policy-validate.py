...
p = subprocess.run(
    ["python3", "watch/executor/execution-window-policy-snapshot.py"],
    text=True,
    capture_output=True,
)
...
for section_name in ["window_schema", "window_rules"]:
...
print("RESULT: PASS")
print("module=governed_execution_window_policy mode=read_only advisory_only=true execution_allowed=false mutation_authority=false executor=spot-core")
