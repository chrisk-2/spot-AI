...
p = subprocess.run(
    ["python3", "watch/executor/execution-replay-audit-snapshot.py"],
    text=True,
    capture_output=True,
)
...
for section_name in ["audit_schema", "audit_rules"]:
...
print("RESULT: PASS")
print("module=deterministic_execution_replay_auditing mode=read_only advisory_only=true execution_allowed=false mutation_authority=false executor=spot-core")
