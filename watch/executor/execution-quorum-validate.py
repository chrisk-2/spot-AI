...
p = subprocess.run(
    ["python3", "watch/executor/execution-quorum-snapshot.py"],
    text=True,
    capture_output=True,
)
...
for section_name in ["quorum_schema", "quorum_rules"]:
...
print("RESULT: PASS")
print("module=execution_quorum_verification mode=read_only advisory_only=true execution_allowed=false mutation_authority=false executor=spot-core")
